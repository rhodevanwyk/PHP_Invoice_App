...
<div class="app-shell" id="app-shell">
    ...
    <aside class="sidebar" id="sidebar" aria-label="Main navigation">
        ...
        <nav class="sidebar__nav">
            <a href="<?= url('/dashboard') ?>" class="sidebar__link<?= ($activeNav ?? '') === 'dashboard' ? ' sidebar__link--active' : '' ?>">
            ...
            <a href="<?= url('/clients') ?>" class="sidebar__link<?= ($activeNav ?? '') === 'clients' ? ' sidebar__link--active' : '' ?>">
